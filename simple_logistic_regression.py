...
adj_adv_stat_team_season = pd.read_csv("p_rating_with_team_id.csv")
adj_adv_stat_team_season = adj_adv_stat_team_season.drop(['AdjTempo', 'AdjORating', 'AdjDRating'], axis=1)
